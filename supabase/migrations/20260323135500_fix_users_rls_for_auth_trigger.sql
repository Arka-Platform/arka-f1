-- Fix OAuth signup failures caused by RLS during auth.users -> public.users trigger.
-- Keep end-user policies strict; allow only internal Supabase roles for trigger writes.
...
-- Ensure profile mirror function stays stable and conflict-safe.
