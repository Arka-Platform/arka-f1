                ...
                <div className={styles.detailList}>
                  <div className={styles.detailRow}>
                    ...
                    <div className={styles.detailText}>
                      Published: <span>{conditionLabel(model.condition)}</span>
                    </div>
                  </div>
                  ...
                  <div className={styles.detailRow}>
                    ...
                    <div className={styles.detailText}>
                      Pages: <span>{requestChip}{nearChip ? ` • ${nearChip}` : ''}</span>
                    </div>
                  </div>
                  ...
                  <div className={styles.detailRow}>
                    ...
                    <div className={styles.detailText}>
                      ...
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                        {(() => {
                          const trustScore = model.providerTrustScore
                          const ratingVal = trustScore == null ? null : Math.min(5, Math.max(0, trustScore / 20))
                          if (ratingVal == null) return <span style={{ opacity: 0.7 }}>Trusted</span>
                          const full = Math.floor(ratingVal)
                          const rem = ratingVal - full
                          return (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 3 }}>
                              ...
                              <span style={{ color: '#7b4a0f' }}>{ratingVal.toFixed(1)}</span>
                            </span>
                          )
                        })()}
                      </span>
            ...
            <div className={styles.aboutCard}>
              <p className={styles.aboutText}>
                {model.description?.trim()
                  ...
                  : 'Proven guide for better reading habits and smooth circulation.'}
              </p>
              <p className={styles.aboutTextMuted}>
                {model.tags.length ? `Transform your routine with ${model.tags.slice(0, 3).join(', ')}.` : 'Transform your life, one small step at a time.'}
              </p>
            </div>
            ...
            <div className={styles.statsCard}>
              <div className={styles.statRow}>
                ...
                <div className={styles.statText}>
                  Over {model.circulationCount} successful circulations
                </div>
              </div>
              ...
              <div className={styles.statRow}>
                ...
                <div className={styles.statText}>
                  Trust score: {model.providerTrustScore != null ? Math.round(model.providerTrustScore) : '—'}
                </div>
              </div>
              ...
              <div className={styles.statRow}>
                ...
                <div className={styles.statText}>
                  Key Concepts: {model.tags.length ? model.tags.slice(0, 3).join(', ') : conditionLabel(model.condition)}
                </div>
              </div>
            </div>
