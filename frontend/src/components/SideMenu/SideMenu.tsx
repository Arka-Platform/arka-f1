  ...
  return (
    <>
      <div className={styles.mobileNavHost}>
        ...
        <div className={styles.mobileBottomBar} data-has-fab={user ? 'true' : 'false'}>
          ...
          {user ? (
            <Link href={addBookHref} className={styles.mobileCenterFab} aria-label="Add a book" title="Add a book">
              <span aria-hidden className={styles.mobileCenterFabPlus}>
                +
              </span>
            </Link>
          ) : null}
